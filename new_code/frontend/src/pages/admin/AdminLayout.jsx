...
import { 
    ...
    Sparkles, FileText, Bell, Settings, LogOut, ChevronDown, Menu, Utensils, QrCode, Coffee, Home
} from 'lucide-react';
            ...
            <div className="flex-1 flex flex-col overflow-hidden bg-[#F7F4ED] rounded-tl-3xl border-t border-l border-[#C8843B]/20 shadow-[-10px_0_30px_rgba(46,26,18,0.03)]">
                <header className="h-20 bg-[#F7F4ED] flex items-center justify-between px-8">
                    <div className="flex items-center gap-3">
                        ...
                        <Link 
                            to="/" 
                            className="flex items-center gap-2 bg-white border border-[#C8843B]/30 px-3.5 py-2 rounded-xl text-xs font-bold text-[#2E1A12] hover:bg-[#C8843B]/10 hover:text-[#C8843B] transition-all shadow-sm"
                            title="Back to Customer Website Home"
                        >
                            <Home className="w-4 h-4 text-[#C8843B]" />
